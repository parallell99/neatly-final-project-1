...
function SelectContent({
  ...
  const preventCloseWhenTrigger = (e) => {
    if (e.target?.closest?.('[data-slot="select-trigger"]')) {
      e.preventDefault();
    }
  };
  ...
  return (
    <SelectPrimitive.Portal>
      <SelectPrimitive.Content
        ...
        onInteractOutside={preventCloseWhenTrigger}
        onPointerDownOutside={preventCloseWhenTrigger}
        className={cn(
