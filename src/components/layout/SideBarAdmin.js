  ...
  return (
    <>
      <div className="bg-green-800 h-dvh w-[240px] flex flex-col gap-[40px]">
        ...
        <div className="flex flex-col">
          {menuItems.map(({ id, label, icon }) => (
            <button
              ...
              className={`flex items-center gap-4 body-1 p-6 cursor-pointer w-full text-green-300 hover:bg-green-700 hover:text-green-100 ${selected === id ? "bg-green-600 text-green-100" : ""}`}
            >
        ...
        <div className="flex gap-4 border-t border-green-700 p-6 mt-auto mb-[210px] text-green-300">
