  ...
  return (
    <>
      ...
      <div
        ...
        className={`z-[1200] w-[52px] lg:w-[64px] lg:h-[64px] h-[52px] flex justify-center bg-green-100 items-center fixed bottom-6 right-6 rounded-full cursor-pointer hover:brightness-95 transition-all shadow-[4px_4px_16px_0px_#00000014] ${isOpen ? "hidden lg:flex" : ""}`}
      >
