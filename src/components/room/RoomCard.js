...
//   const guestsPerRoom = Number(room.guests_per_room ?? room.max_guests ?? 2);
...
//       // สำเร็จ → ไปหน้า booking/confirmation
//       router.push(`/booking${slug ? `?booking=${slug}` : ""}`);
//     } catch (err) {
...
//             {/* ── Availability Warning: ห้องไม่พอ ── */}
...
//                   ห้องไม่เพียงพอสำหรับการค้นหาของคุณ
//                 </p>
//                 <p className="body-1 text-amber-700 mt-1">
//                   คุณต้องการ <strong>{roomsNeeded} ห้อง</strong> แต่มีเพียง{" "}
//                   <strong>{availableRooms} ห้อง</strong> ที่ว่างอยู่
//                   {unaccommodatedGuests > 0 && (
//                     <>
//                       {" "}— จะมีผู้เข้าพักที่รองรับไม่ได้อีก{" "}
//                       <strong>{unaccommodatedGuests} ท่าน</strong>
//                     </>
//                   )}
//                 </p>
//               </div>
...
//                   ไม่มีห้องว่างสำหรับวันที่ที่เลือก
//                 </p>
//               </div>
//             )}
...
//             <p className="body-1 text-gray-700 leading-relaxed">
//               {room.description}
//             </p>
//           </div>
...
//               THB {room.promotion_price_per_night}
//             </p>
